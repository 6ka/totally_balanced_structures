...
class Graph(object):
    ...
    def paths_from(self, root, f=lambda x: 1, forbidden_vertices=frozenset()):
        ...
        return self._inner_path_tree(root, f, forbidden_vertices)

    def _inner_path_tree(self, root, f=lambda x: 1, forbidden_vertices=frozenset(), stop_if_vertex=None):
        """Shortest paths (Bellman-Ford algorithm).
