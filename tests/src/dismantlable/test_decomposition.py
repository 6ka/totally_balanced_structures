...
from tbs.dismantlable._tree_decomposition import DecompositionBTB
from tbs.lattice import isa_lattice_directed_comparability_graph
from tbs.graph import Graph, DirectedGraph, BinaryMixedTree


class TestDecomposition(unittest.TestCase):
    @staticmethod
    def new_lattice():
        lattice = DirectedGraph.from_edges([("bottom", 1),
                                            ("bottom", 2),
                                            ("bottom", 3),
                                            ("bottom", 4),
                                            (1, 5),
    ...
    def test_algo(self):
        decomposition = DecompositionBTB(Graph(vertices=[0, 1, 2, 3, 4, 5, 6], edges=((0, 1), (0, 2), (0, 3), (1, 4), (2, 5), (3, 6))))
    ...
    def test_contraction_trees(self):
        small_binary_lattice = DirectedGraph((1, 2, 3, 4, 5, 'bottom', 'top'), (
    ...
    def test_contraction_trees_more_specific_order(self):
        binary_atomistic_lattice = DirectedGraph(
        ...
        support_tree = DismantlableLattice(binary_atomistic_lattice).support_tree()
    ...
    def test_contraction_trees(self):
        binary_atomistic_lattice = DismantlableLattice(
            ...
            edges=[('BOTTOM', 16), ('BOTTOM', 17), ('BOTTOM', 18), ('BOTTOM', 3), ('BOTTOM', 4), ('BOTTOM', 1),
                   ...
                   (19, 11), (15, 6), (0, 12), (11, 12), (12, 2), (3, 2), (2, 9), (18, 9), (9, 8), (17, 8), (8, 13),
                   (6, 13), (13, 'TOP'), (7, 'TOP'), (5, 7), (16, 7)])
        decomposition = tree_decomposition_of_binary_lattice(binary_atomistic_lattice)
