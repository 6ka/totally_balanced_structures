...
from tbs.lehelian import random_hypergraph
...
class TestInit(unittest.TestCase):
    ...
    def test_one_vertex(self):
        self.assertEqual(random_hypergraph((1,)), frozenset((frozenset((1,)),)))

    def test_one_edge(self):
        self.assertEqual(random_hypergraph((1, 2)), frozenset((frozenset((1,)), frozenset((2,)), frozenset((1, 2)))))
    ...
    def test_path(self, mocked_random_tree):
        ...
        self.assertEqual(random_hypergraph([1, 2, 3, 4]),
    ...
    def test_number_clusters(self):
        self.assertEqual(len(random_hypergraph(list(range(10)))), 11 * 10 / 2)
