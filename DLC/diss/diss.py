...
class Diss(object):
    ...
    def __init__(self, elements=tuple(), value=0):
        ...
        :param elements: pairwise different.
    ...
    def __setitem__(self, pair, value):
        ...
        x, y = pair
        idx1, idx2 = self._vertex.index(x), self._vertex.index(y)
    ...
    def restriction(self, element_subset):
        ...
        d = self.__class__(element_subset)
        d.update(self, True)
    ...
    def rename(self, x, new_x):
        ...
        self._vertex[self._vertex.index(x)] = new_x
    ...
    def __add__(self, other_dissimilarity):
        ...
        :type other_dissimilarity: :class:`CTK.diss.Diss`
